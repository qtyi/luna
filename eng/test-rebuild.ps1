<#
  This script tests that Luna artifacts are rebuildable--i.e. that the source code and resources can be identified
#>
...
# Rebuilds with output differences
  #" --exclude net472\Qtyi.CodeAnalysis.EditorFeatures.Wpf.dll" +
  #" --exclude net472\Qtyi.VisualStudio.LanguageServices.[LangName].dll" +
  " --exclude net472\Luna.Hosting.Diagnostics.dll" +
  " --exclude net472\Luna.VisualStudio.DiagnosticsWindow.dll" +
...
# Rebuilds with other issues
  ...
  " --exclude net9.0\GeneratedRefAssemblies\Qtyi.CodeAnalysis.dll" +
