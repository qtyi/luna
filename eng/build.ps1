#
# This script controls the Luna build process. This encompasess everything from build, testing to
...
function Deploy-VsixViaTool() {
  ...
  Write-Host "Uninstalling old Luna VSIX"
  ...
  Write-Host "Installing all Luna VSIX"
