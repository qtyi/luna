...
public static partial class SyntaxFacts
{
    ...
    {
        if (!CheckAndAdjustLanguageVersion(ref version))
            yield break;
    ...
    public static IEnumerable<SyntaxKind> GetDotnetKeywords(LanguageVersion version)
    {
        ...
        // Only available in preview version.
    ...
    public static partial bool IsContextualKeyword(SyntaxKind kind, LanguageVersion version) =>
        ...
        IsVariableAttributeKeyword(kind, version) ||

        // Dotnet keywords
        IsDotnetKeyword(kind, version);
    ...
    #region Punctuation
    public static partial bool IsPunctuation(SyntaxKind kind, LanguageVersion version) => kind switch
    {
    ...
    public static partial bool IsPreprocessorDirective(SyntaxKind kind, LanguageVersion version) => kind switch
    {
        ...
        SyntaxKind.CommentDirectiveTrivia => true,
