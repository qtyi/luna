...
internal sealed class SourceNetmoduleSymbol : NetmoduleSymbol
{
        ...
        string netmoduleName)
    {
        ...
        this._sources = declarations;
        this._name = netmoduleName;
    }
    ...
    internal SourceAssemblySymbol ContainingSourceAssembly => this._assemblySymbol;
    #endregion

    #region Declaring
    /// <inheritdoc/>
    public override ThisCompilation? DeclaringCompilation => this._assemblySymbol.DeclaringCompilation;
    #endregion

    internal override int Ordinal => 0;

    internal override Machine Machine => this.DeclaringCompilation.Options.Platform switch
    {
    ...
    internal override bool Bit32Required => this.DeclaringCompilation.Options.Platform == Platform.X86;
