...
internal struct SymbolCompletionState
{
    ...
    /// </summary>
    /// <value>未完成的组件。</value>
    internal int IncompleteParts => ~this._completeParts & (int)CompletionPart.All;
    ...
    internal bool HasComplete(CompletionPart part) => (this._completeParts & (int)part) == (int)part;

#pragma warning disable CS0420
    internal bool NotePartComplete(CompletionPart part) => ThreadSafeFlagOperations.Set(ref this._completeParts, (int)part);
