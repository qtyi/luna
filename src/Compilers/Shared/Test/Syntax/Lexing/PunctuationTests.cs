...
public partial class PunctuationTests(ITestOutputHelper output) : LexingTestBase
{
    ...
    public static readonly TheoryData<LanguageVersion, SourceCodeKind> ShebangSupportiveLanguageVersionsAndSourceCodeKind =
        SyntaxFactsTests.EffectiveLanguageVersions
        ...
        SourceCodeKind kind)
    {
        ...
        foreach (var info in SyntaxFactsTests.GetExpectedSyntaxKindInfos_Punctuation(version))
        {
            ...
            if (info.Kind == SyntaxKind.HashExclamationToken)
            {
                ...
                [
                    Diagnostic(ErrorCode.WRN_ShebangOnlySupportedInScript).WithLocation(1, 1)
                ];
    ...
    private enum ShebangPosition : byte
    {
        /// <summary>
        ...
        AtFileStart,
        /// <summary>
        /// At the first line and before the first token but after whitespace.
        /// </summary>
        AtFirstLineBeforeFirstToken,
        /// <summary>
        /// Not at the first line and before the first token.
        /// </summary>
        NotAtFirstLineBeforeFirstToken,
        /// <summary>
