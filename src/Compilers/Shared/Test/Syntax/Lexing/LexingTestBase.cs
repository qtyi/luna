...
{
    public static readonly TheoryData<LanguageVersion, SourceCodeKind> EffectiveLanguageVersionsAndSourceCodeKind = new CombinatorialTheoryData<LanguageVersion, SourceCodeKind>(
        SyntaxFactsTests.EffectiveLanguageVersions,
        new EnumTheoryData<SourceCodeKind>()
    );
