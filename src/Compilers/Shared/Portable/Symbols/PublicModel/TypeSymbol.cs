...
{
    internal abstract InternalModel.Symbols.TypeSymbol UnderlyingTypeSymbol { get; }
    internal sealed override InternalModel.Symbols.ModuleSymbol UnderlyingModuleSymbol => throw new NotImplementedException();
