...
{
    private readonly InternalModel.Symbols.DynamicTypeSymbol _underlying;

    internal override Symbols.TypeSymbol UnderlyingTypeSymbol => this._underlying;

    public DynamicTypeSymbol(InternalModel.Symbols.DynamicTypeSymbol underlying, NullableAnnotation nullableAnnotation) : base()
    {
