...
partial class ModuleSymbol
{
    ...
    bool Microsoft.CodeAnalysis.Symbols.IMethodSymbolInternal.IsIterator => this.IsIteratorCore;
    bool Microsoft.CodeAnalysis.Symbols.IMethodSymbolInternal.IsAsync => this.IsAsyncCore;
    int Microsoft.CodeAnalysis.Symbols.IMethodSymbolInternal.CalculateLocalSyntaxOffset(int declaratorPosition, Microsoft.CodeAnalysis.SyntaxTree declaratorTree) => this.CalculateLocalSyntaxOffsetCore(declaratorPosition, declaratorTree);
    Microsoft.CodeAnalysis.Symbols.IMethodSymbolInternal Microsoft.CodeAnalysis.Symbols.IMethodSymbolInternal.Construct(params Microsoft.CodeAnalysis.Symbols.ITypeSymbolInternal[] typeArguments) => this.ConstructCore(typeArguments);
    #endregion
}
