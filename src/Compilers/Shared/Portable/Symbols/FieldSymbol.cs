...
partial class FieldSymbol : ModuleSymbol, IFieldSymbolInternal
{
    ...
    public TypeSymbol Type => this.TypeWithAnnotations.Type;
    ...
    /// </value>
    public new FieldSymbol OriginalDefinition => this.OriginalFieldSymbolDefinition;
    ...
    protected sealed override Symbol OriginalSymbolDefinition => this.OriginalFieldSymbolDefinition;
    #endregion

    #region GetMembers
    /// <inheritdoc/>
    public override ImmutableArray<ModuleSymbol> GetMembers() => this.GetFieldMembers().Cast<FieldSymbol, ModuleSymbol>();

    /// <inheritdoc/>
    public override ImmutableArray<ModuleSymbol> GetMembers(string name) => this.GetFieldMembers(name).Cast<FieldSymbol, ModuleSymbol>();
    ...
    /// <inheritdoc/>
    protected sealed override Microsoft.CodeAnalysis.TypeKind TypeKindCore => Microsoft.CodeAnalysis.TypeKind.Unknown;
    ...
    /// <inheritdoc/>
    protected sealed override Microsoft.CodeAnalysis.ITypeSymbol GetITypeSymbolCore() => throw ExceptionUtilities.Unreachable();
    #endregion
