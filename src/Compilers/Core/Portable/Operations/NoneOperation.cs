...
/// <summary>
/// Use this to create <see cref="IOperation"/> when we don't have proper specific <see cref="IOperation"/> yet for given language construct
/// </summary>
internal sealed class NoneOperation : Operation
{
    ...
    /// <inheritdoc/>
    public override TResult? Accept<TArgument, TResult>(OperationVisitor<TArgument, TResult> visitor, TArgument argument) where TResult : default => visitor.VisitNoneOperation(this, argument);
}
