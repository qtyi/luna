...
partial class DynamicTypeSymbol : TypeSymbol
{
    ...
    /// <inheritdoc/>
    protected override TypeKind TypeKindCore => TypeKind.Dynamic;
    ...
    {
        Debug.Assert(Equals(other, TypeCompareKind.IgnoreDynamicAndTupleNames | TypeCompareKind.IgnoreNullableModifiersForReferenceTypes));
        return this;
    }

    #region Public Symbol
    protected override ISymbol CreateISymbol() => new PublicModel.DynamicTypeSymbol(this, DefaultNullableAnnotation);
