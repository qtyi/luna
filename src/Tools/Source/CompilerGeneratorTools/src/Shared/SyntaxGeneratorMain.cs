...
internal static class Program
{
    ...
    private static Task WriteToFileAsync(Action<TextWriter, SyntaxTree, CancellationToken> writeAction, SyntaxTree tree, string outputFile)
    {
        return Task.Run(() =>
        {
            try
            {
                ...
                writeAction(outFile, tree, s_cancellationTokenSource.Token);
            }
