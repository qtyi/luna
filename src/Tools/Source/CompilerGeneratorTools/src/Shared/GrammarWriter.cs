...
internal sealed class GrammarWriter : TreeFileWriter<SyntaxTree, SyntaxTreeType>
{
    ...
    public static void WriteFile(TextWriter writer, SyntaxTree tree, CancellationToken cancellationToken) => new GrammarWriter(writer, tree, cancellationToken).WriteFile();
