...
internal class SyntaxSourceWriter : SyntaxFileWriter
{
    ...
    /// 写入红树节点的访问、重写和工厂方法。
    /// </summary>
    public static void WriteMain(TextWriter writer, SyntaxTree tree, CancellationToken cancellationToken) => new SyntaxSourceWriter(writer, tree, cancellationToken).WriteMain();

    /// <summary>
    /// 写入绿树节点的类型定义及访问、重写和上下文、静态工厂方法。
    /// </summary>
    public static void WriteInternal(TextWriter writer, SyntaxTree tree, CancellationToken cancellationToken) => new SyntaxSourceWriter(writer, tree, cancellationToken).WriteInternal();

    /// <summary>
    /// 写入红树节点的类型定义。
    /// </summary>
    public static void WriteSyntax(TextWriter writer, SyntaxTree tree, CancellationToken cancellationToken) => new SyntaxSourceWriter(writer, tree, cancellationToken).WriteSyntax();
