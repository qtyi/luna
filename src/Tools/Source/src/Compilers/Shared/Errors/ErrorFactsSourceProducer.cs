...
internal sealed class ErrorFactsSourceProducer(ErrorFactsSourceProductionContext context)
{
    private const string Identifier_CodeAnalysis = "CodeAnalysis";
    private const string Identifier_ErrorCode = "ErrorCode";
    private const string Identifier_ErrorFacts = "ErrorFacts";
    private const string Identifier_Qtyi = "Qtyi";

    public ErrorFactsSourceProductionContext Context { get; } = context;
    ...
    private MethodDeclarationSyntax ProduceCategoryMethod(string category, ImmutableArray<string> codeNames)
    {
