...
internal sealed class LexerCacheSourceProvider(LexerCacheSourceProductionContext context)
{
    ...
    private const string Identifier_CodeAnalysis = "CodeAnalysis";
    private const string Identifier_Collections = "Collections";
    private const string Identifier_Immutable = "Immutable";
    private const string Identifier_InternalSyntax = "InternalSyntax";
    private const string Identifier_LexerCache = "LexerCache";
    private const string Identifier_Qtyi = "Qtyi";
    private const string Identifier_Syntax = "Syntax";
    private const string Identifier_SyntaxKind = "SyntaxKind";
    private const string Identifier_System = "System";

    public LexerCacheSourceProductionContext Context { get; } = context;

    public SyntaxTree Produce()
    {
    ...
    private FileScopedNamespaceDeclarationSyntax ProduceNamespace()
    {
        return FileScopedNamespaceDeclaration(
            ...
            name: QualifiedName(QualifiedName(QualifiedName(QualifiedName(
                ...
                IdentifierName(Context.ThisLanguageName)),
    ...
    {
        var group = (from name in Context.KeywordKindNames
                     let text = name[0..^7].ToLowerInvariant()
        ...
        return ClassDeclaration(
            ...
            members: ProduceFields(group.Key, group.ToArray()));
    }

    private SyntaxList<MemberDeclarationSyntax> ProduceFields(int length, (string KindName, string KeywordText)[] tuples)
    {
