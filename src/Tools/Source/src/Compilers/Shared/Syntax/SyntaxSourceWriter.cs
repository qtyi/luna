...
internal class SyntaxSourceWriter : SyntaxFileWriter
{
    ...
    private void WriteFileHeader()
    {
        ...
        this.WriteLine($"using Qtyi.CodeAnalysis.{ThisLanguageName};");
    ...
    private void WriteMain()
    {
        ...
        this.WriteLine($"namespace Qtyi.CodeAnalysis.{ThisLanguageName}");
        this.OpenBlock();
        this.WriteLine("using System.Diagnostics.CodeAnalysis;");
        this.WriteLine("using Microsoft.CodeAnalysis;");
        this.WriteLine($"using Qtyi.CodeAnalysis.{ThisLanguageName}.Syntax;");
    ...
    {
        this.WriteFileHeader();
        this.WriteLine($"namespace Qtyi.CodeAnalysis.{ThisLanguageName}.Syntax.InternalSyntax");
        this.OpenBlock();
    ...
    {
        this.WriteFileHeader();
        this.WriteLine($"namespace Qtyi.CodeAnalysis.{ThisLanguageName}.Syntax");
        this.OpenBlock();
        this.WriteLine("using Microsoft.CodeAnalysis;");
        this.WriteRedTypes();
        this.CloseBlock();
    ...
    private void WriteGreenType(SyntaxTreeType node)
    {
        ...
        else if (node is Node)
        {
            ...
            foreach (var field in nodeFields)
            {
                ...
                {
                    this.WriteLine($"public {OverrideOrNewModifier(field)}Microsoft.CodeAnalysis.Syntax.InternalSyntax.{field.Type} {overriddenName} => new Microsoft.CodeAnalysis.Syntax.InternalSyntax.{field.Type}(new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<{ThisLanguageName}SyntaxNode>(this.{CamelCase(field.Name)}));");
                    if (field.IsOverride() && !directlyOverride)
                        this.WriteLine($"public Microsoft.CodeAnalysis.Syntax.InternalSyntax.{field.Type} {field.Name} => new Microsoft.CodeAnalysis.Syntax.InternalSyntax.{field.Type}(new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<{ThisLanguageName}SyntaxNode>(this.{CamelCase(field.Name)}));");
                }
                else if (field.Type == "SyntaxNodeOrTokenList")
                {
                    this.WriteLine($"public {OverrideOrNewModifier(field)}Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<{ThisLanguageName}SyntaxNode> {overriddenName} => new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<{ThisLanguageName}SyntaxNode>(this.{CamelCase(field.Name)});");
                    if (field.IsOverride() && !directlyOverride)
                        this.WriteLine($"public Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<{ThisLanguageName}SyntaxNode> {field.Name} => new Microsoft.CodeAnalysis.Syntax.InternalSyntax.SyntaxList<{ThisLanguageName}SyntaxNode>(this.{CamelCase(field.Name)});");
                }
                else
                {
            ...
            this.WriteLine();
            this.WriteLine($"internal override SyntaxNode CreateRed(SyntaxNode? parent, int position) => new {ThisLanguageName}.Syntax.{node.Name}(this, parent as {ThisLanguageName}.{ThisLanguageName}SyntaxNode, position);");
    ...
    {
        this.WriteLine();
        this.WriteLine($"public override void Accept({ThisLanguageName}SyntaxVisitor visitor) => visitor.Visit{StripPost(node.Name, "Syntax")}(this);");
        this.WriteLine($"public override TResult? Accept<TResult>({ThisLanguageName}SyntaxVisitor<TResult> visitor) where TResult : default => visitor.Visit{StripPost(node.Name, "Syntax")}(this);");
    }
    ...
    private void WriteGreenVisitor(bool withResult)
    {
        ...
        this.WriteLine();
        this.WriteLine($"partial class {ThisLanguageName}SyntaxVisitor" + (withResult ? "<TResult>" : ""));
        this.OpenBlock();
    ...
    private void WriteGreenAccumulator()
    {
        ...
        this.WriteLine();
        this.WriteLine($"partial class {ThisLanguageName}SyntaxAccumulator<TResult> : {ThisLanguageName}SyntaxVisitor<IEnumerable<TResult>>");
        this.OpenBlock();
        int nWritten = 0;
        foreach (var node in nodes.OfType<Node>())
        {
    ...
    private void WriteGreenTraverser()
    {
        ...
        this.WriteLine();
        this.WriteLine($"partial class {ThisLanguageName}SyntaxTraverser : {ThisLanguageName}SyntaxVisitor");
        this.OpenBlock();
        int nWritten = 0;
        foreach (var node in nodes.OfType<Node>())
        {
    ...
    private void WriteGreenRewriter()
    {
        ...
        this.WriteLine();
        this.WriteLine($"partial class {ThisLanguageName}SyntaxRewriter : {ThisLanguageName}SyntaxVisitor<{ThisLanguageName}SyntaxNode>");
        this.OpenBlock();
        int nWritten = 0;
        foreach (var node in nodes.OfType<Node>())
        {
            ...
            if (nWritten > 0)
                this.WriteLine();
            nWritten++;
            this.WriteLine($"public override {ThisLanguageName}SyntaxNode Visit{StripPost(node.Name, "Syntax")}({node.Name} node)");
            Indent();
    ...
    private void WriteGreenFactory(Node nd, bool withSyntaxFactoryContext = false)
    {
            ...
            valueFields.Count + nodeFields.Count <= 3)
        {
            ...
            {
                this.Write($"var cached = {ThisLanguageName}SyntaxNodeCache.TryGetNode((int)");
            }
            else
            {
    ...
    private void WriteRedType(SyntaxTreeType node)
    {
        ...
        if (node is AbstractNode)
        {
            ...
            this.OpenBlock();
            this.WriteLine($"internal {node.Name}(InternalSyntax.{ThisLanguageName}SyntaxNode green, {ThisLanguageName}SyntaxNode? parent, int position)");
    ...
    private void WriteRedAcceptMethod(Node node, bool genericResult)
    {
        ...
        this.WriteLine($"public override {(genericResult ? "TResult?" : "void")} Accept{genericArgs}({ThisLanguageName}SyntaxVisitor{genericArgs} visitor){(genericResult ? " where TResult : default" : "")} => visitor.Visit{StripPost(node.Name, "Syntax")}(this);");
    }
    ...
    private void WriteRedVisitor(bool genericResult)
    {
        ...
        this.WriteLine();
        this.WriteLine($"partial class {ThisLanguageName}SyntaxVisitor{genericArgs}");
        this.OpenBlock();
        int nWritten = 0;
        foreach (var node in nodes.OfType<Node>())
        {
    ...
    private void WriteRedRewriter()
    {
        ...
        this.WriteLine();
        this.WriteLine($"partial class {ThisLanguageName}SyntaxRewriter : {ThisLanguageName}SyntaxVisitor<SyntaxNode>");
        this.OpenBlock();
