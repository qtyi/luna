...
namespace Luna.Compilers.Generators.Operations.Model;

#pragma warning disable CS8618
[XmlRoot(ElementName = "Tree")]
public class OperationsTree : ITree<OperationsTreeType>
{
    [XmlAttribute]
    public string Root;
    ...
    public List<OperationsTreeType> Types;

    string ITree<OperationsTreeType>.Root => this.Root;

    ImmutableList<OperationsTreeType> ITree<OperationsTreeType>.Types => this.Types.ToImmutableList();
}

public abstract class OperationsTreeType : ITreeType
{
    [XmlAttribute]
    public string Name;
...
public class AbstractNode : OperationsTreeType
{
